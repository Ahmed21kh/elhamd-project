...
import styles from "./StoresCounting.module.css";
  ...
  return (
    <>
      ...
      >
        ...
        <HeaderComponent title="حساب المخازن " />
        {/* </div> */}
        <div
          style={{
            display: "flex",
          ...
          {!showAccountTable ? (
            ...
            >
              ...
              <input
                ...
                type="search"
                placeholder="إبحث عن اسم المخزن"
                style={{
                  width: "80%",
                  padding: "0.8em",
                  border: "none",
