...
import styles from "./ClientsAccounting.module.css";
...
export const ClientsAccounting = () => {
  //states//
  ...
  return (
    <>
      ...
      >
        ...
        <HeaderComponent title="حساب العملاء " />
        {/* </div> */}
        <div
          style={{
            display: "flex",
...

        {
          showAccountTable?(<>
           ...
           <div style={{width:"60%",margin:"2em auto",border:"1px solid",padding:"1em",position:"relative",border:"none",backgroundColor:"white",boxShadow:"1px 3px 10px 0px rgb(0 0 0 / 30%)"}}>
              ...
              <div style={{padding:"0.5em",fontSize:"16px"}}>{`اسم العميل / شركة الحمد`}</div>
