  ...
  // end of modal functions
    ...
    return(
        ...
        <div style={{display: "flex",flexDirection: "column",justifyContent: "center",alignItems:"center" }}>
         ...
         <HeaderComponent  title="الموردين " width="100%"/>
       ...
       <BiSearch style={{ fontSize:"20px",position:"absolute",top: "10px",right:"20px",opacity: "0.6" }}/>
         ...
         <button style={{width: "15%",height: "30px" ,padding:"0.5em 0em",border:"none",
           ...
           alignItems:"center",justifyContent:"center"}}><FiPlusCircle style={{marginLeft: "0.5em"}}/>إضافة مورد</button>
         </div>
         {/* <Table 
         columns={columns} 
         dataSource={data}
...
>
    ...
    <Column className={styles.coll} title='كود المورد' dataIndex="code" key="code" />
    ...
    <Column
      ...
      render={(_, record) => (
        ...
        <button style={{width:"100px",borderRadius: "15px",border:"1px solid gray",padding:"0.25em",
                          display:"flex",justifyContent:"center",alignItems:"center",cursor:"pointer",
                          color: "white",backgroundColor:"green" }}><FiPlusCircle style={{marginLeft: "0.5em"}}/>إضافة مورد</button>
        </Space>
      )}
    />
  </Table>
