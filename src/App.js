...
;
  ...
  // );
    ...
    <>
     {isLogined?(
      <Routes>
        <Route path="/login" element={<Login login={handleLogin} handleResetPassword={showResetPassword}/>} />
        <Route path="/reset-password" element={<ResetPassword handleLogin={handleClic}/>} />
      </Routes>
     ):(
          ...
          >
            ...
            >
                  ...
                  <Route path='/' element={<Main />} />
                      ...
                      <Route path='/clients-accounting' element={<ClientsAccounting />} />
                      <Route path='/supplieres-accounting' element={<SupplieresAccounting />} />
                      <Route path='/salaries-counting' element={<SalariesCounting />} />
                      <Route path='/stores-counting' element={<StoresCounting />} />
                      <Route path='/sales-accounting' element={<SalesCounting />} />
                      <Route path='/purchases-accounting' element={<PurchasesCounting/>} />
                      <Route path='/daily-voucherReceipt' element={<DailyVoucherReceipt/>} />
                      <Route path='/daily-catchReceipt' element={<DailyCatchReceipt/>} />
                  </Routes>
